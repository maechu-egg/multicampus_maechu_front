...
const badgeGuides: BadgeGuideItem[] = [
  {
    badge: "다이아몬드",
    image: process.env.PUBLIC_URL + '/img/personalBadge/badgeDiamond.png',
    requiredScore: 100,
    description: "최고 등급의 뱃지입니다."
  },
  {
    badge: "플래티넘",
    image: process.env.PUBLIC_URL + '/img/personalBadge/badgePlatinum.png',
    requiredScore: 70,
    description: "상위 10%의 뱃지입니다."
  },
  {
    badge: "골드",
    image: process.env.PUBLIC_URL + '/img/personalBadge/badgeGold.png',
    requiredScore: 50,
    description: "상위 30%의 뱃지입니다."
  },
  {
    badge: "실버",
    image: process.env.PUBLIC_URL + '/img/personalBadge/badgeSilver.png',
    requiredScore: 30,
    description: "상위 50%의 뱃지입니다."
  },
  {
    badge: "브론즈",
    image: process.env.PUBLIC_URL + '/img/personalBadge/badgeBronze.png',
    requiredScore: 10,
    description: "운동과 식단을 시작한 뱃지입니다."
  },
  {
    badge: "뉴비",
    image: process.env.PUBLIC_URL + '/img/personalBadge/badgeDefault.png',
    requiredScore: 0,
    description: "첫 시작을 환영합니다!"
  }
];

function BadgeScoreGuide() {
